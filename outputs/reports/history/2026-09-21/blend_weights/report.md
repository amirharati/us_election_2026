Archived execution date (UTC): **2026-09-21**. Run: `20260921T185706.381747Z`. Same-day reruns replace this copy; other dates are retained.

# Blend-weight comparison

Complete supporting results · [Run settings](supporting_run.json)

Latest execution: `20260921T185706.381747Z`. Forecast cutoff: **frozen historical/reference inputs**.
