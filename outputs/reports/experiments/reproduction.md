...
[Complete supporting results](../../results/experiments/reproduction/) · [Run settings](../../results/experiments/reproduction/run.json)

Latest execution: `20260921T044200.057751Z`. Forecast cutoff: **frozen historical/reference inputs**.
...
For all scenarios, per-state tables, sampler diagnostics and exact provenance, see the [complete result bundle](../../results/experiments/reproduction/).
