...
[Complete supporting results](../../results/experiments/older_alternatives/) · [Run settings](../../results/experiments/older_alternatives/run.json)
...
For all scenarios, per-state tables, sampler diagnostics and exact provenance, see the [complete result bundle](../../results/experiments/older_alternatives/).
